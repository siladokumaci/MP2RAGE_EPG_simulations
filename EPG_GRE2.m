function [F0,Fn,Zn,F] = EPG_GRE2(theta,phi,TR,T1,T2,varargin)
%   [F0,Fn,Zn,F] = EPG_GRE2(theta,phi,TR,T1,T2,varargin)
%
...
for ii=1:length(varargin)
    ...
    % Initial Magnetization - value between 0 and 1
    % Added by Sila Dokumaci on 24.02.2020
...
%%% regrowth
b = zeros([N 1]);
b(3) = zinit*(1-E1);%<--- just applies to Z0 % zinit was added by Sila Dokumaci on 13.11.2020
...
if exist('prep','var')
    ...
    FF(3) = E1p * FF(3) + zinit*(1-E1p);% M0 factor zinit was added by Sila Dokumaci on 13.11.2020
end
